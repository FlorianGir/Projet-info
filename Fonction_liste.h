...
typedef enum LEXEME {DEBUT, COMMENT, NL, SYMBOLE, DEUX_PTS, DIRECTIVE, VIRGULE, ETIQUETTE, DECIMAL, DECIMAL_ZERO, HEXA, AUTRE, REGISTRE, GUIL, PAR_O, PAR_F} LEXEME; 
...
L_LEX ajout_queue_lex(L_LEX l, LEXEME lex, MOT l_mot, int ligne);
...
void Virgule(L_LEX lex, MOT *mot, int ligne);
